...
Column {
    ...
    Repeater {
        ...
        Column {
            ...
            topPadding: isSliderOnlyRow ? (root.editMode ? 4 : 0) : 0
            bottomPadding: isSliderOnlyRow ? (root.editMode ? 4 : 0) : 0
                    ...
                    DragDropWidgetWrapper {
                        ...
                        widgetComponent: {
                            ...
                            if (id.startsWith("builtin_")) {
                                ...
                                return widgetWidth <= 25 ? smallCpuUsageComponent : cpuUsagePillComponent;
                            } else if (id === "memUsage") {
                                return widgetWidth <= 25 ? smallMemUsageComponent : memUsagePillComponent;
                            } else if (id === "gpuUsage") {
                                return widgetWidth <= 25 ? smallGpuUsageComponent : gpuUsagePillComponent;
                            } else if (id === "fanControl") {
                                return widgetWidth <= 25 ? smallFanControlComponent : fanControlPillComponent;
    ...
    Component {
        id: smallFanControlComponent
        SmallFanControlButton {
            property var widgetData: parent.widgetData || {}
            property int widgetIndex: parent.widgetIndex || 0
            width: parent.width
            height: 48
