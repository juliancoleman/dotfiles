...
QtObject {
    ...
    readonly property var coreWidgetDefinitions: [
        ...
        },
        {
            "id": "cpuUsage",
            "text": I18n.tr("CPU"),
            "description": I18n.tr("Processor usage"),
            "icon": "memory",
            "type": "action",
        ...
        },
        {
            "id": "gpuUsage",
            "text": I18n.tr("GPU"),
            "description": I18n.tr("Graphics usage and temperature"),
        ...
        },
        {
            "id": "fanControl",
            "text": I18n.tr("Fans"),
            "description": I18n.tr("Fan speed override"),
            "icon": "mode_fan",
            "type": "action",
            "enabled": true
        },
